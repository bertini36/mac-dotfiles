...
1. Dispatch the `code-reviewer` agent to scan for architecture, performance, code quality, and testing issues. Tell it to skip its Security category; the `security-reviewer` owns that.
